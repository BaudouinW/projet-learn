...
use Learn\ProjectBundle\Entity\Article;
use Learn\ProjectBundle\Form\ArticleType;
...
class ArticleController extends Controller {
    ...
    public function ModifAction($id, Request $request) {
        ...
        $em = $this->getDoctrine()->getManager();
        $article = $em->getRepository('LearnProjectBundle:Article')->find($id);
    ...
    public function DetailAction($id) {
        ...
        $article = $this->getDoctrine()->getManager()->getRepository('LearnProjectBundle:Article')->find($id);
